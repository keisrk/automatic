...
set falls in the interpretation of the predicate. \todo{talk in terms of regular
 set, closure prop and emptiness checking} We can perform set operations over
...
\todo{What is the difficulty of the problem?}  \todo{NFA implementation of the
