...
\todo{What is the problem spec, i.e., input/output?}
...
predicate.  \todo{talk in terms of regular set, closure prop and emptiness
  checking} We can perform set operations over the regular sets along with the
...
\todo{What is the difficulty of the problem?}
\todo{NFA implementation of the regular set}
...
\todo{How did existing works handle the problem?}
\todo{
...
\todo{What's new in our work?}
To handle formula not limited to prefix normal form, we extend the antichain
